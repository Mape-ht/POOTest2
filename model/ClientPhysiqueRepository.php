...
function addClientPhy($clientPhysique){
    ...
    if($prepare->execute(array($clientPhysique->getNomsClt(),$clientPhysique->getPrenoms(),$clientPhysique->getPhone(),$clientPhysique->getStatut(),$clientPhysique->getSalaire(),$clientPhysique->getAdresse(),$clientPhysique->getEmail(),$clientPhysique->getNumIdTravail(),$clientPhysique->getTypeclt(),$clientPhysique->getCltmoral()))){
